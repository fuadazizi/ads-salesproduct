        ...
        <div class="accordion-item rounded-0" style="width: 70px; border: none;">
            <h2 class="accoridon-header mb-0" id="headplatform-{{ $i }}">
                <button class="accordion-button rounded-0 collapsed bg-white" type="button" data-mdb-toggle="collapse" data-mdb-target="#colplatform-{{ $i }}" aria-expanded="false" aria-controls="colplatform-{{ $i }}" value="{{ $i }}">
                    @if ($i == 1) <i class="fa-solid fa-desktop"></i>
                    @elseif ($i == 2) <i class="fa-solid fa-mobile-alt"></i>
                    @elseif ($i == 3) <i class="fa-solid fa-mobile"></i>
                    @else Invalid
                    @endif
                </button>
            </h2>
            <div id="colplatform-{{ $i }}" class="accordion-collapse collapse collapse-horizontal platform" aria-labelledby="headplatform-{{ $i }}" data-mdb-parent="#accordion-platform" style="left: 70px;position: absolute;top: 0;background: white;">
                <div class="accordion-body accordion p-0" id="accordion-banner-{{ $i }}">
