...
<body>
    <img src="{{ asset('assets/images/logo.png') }}" alt="logo-salesproduct"
        class="logo-salesproduct" style="">

    <center class="d-flex align-items-center flex-column justify-content-center" style="height: 100vh;">
        <h1 class="text-dark" style=""> Great things coming soon. </h1>
        <p style="">Kindly reach out to our sales team to request your personalized preview link.</p>
